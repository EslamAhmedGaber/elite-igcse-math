...
const promoUrl = "http://127.0.0.1:8766/promo.html?video=1";
const durationSeconds = 28.25;
const output = resolve(root, "assets", "elite-igcse-promo.mp4");
const framesDir = resolve(root, ".promo-frames");
...
if (frame < 30) {
  throw new Error(`Only captured ${frame} frames. The browser screencast did not record correctly.`);
}
